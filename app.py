"""
UAE Sales Analytics Dashboard  —  Streamlit + Pandas + Plotly
==============================================================
...
# Lightweight CSS: a gradient header banner and slightly tighter metric cards.
st.markdown(
    """
    <style>
      .app-banner {
          background: linear-gradient(110deg, #4338ca 0%, #6366f1 55%, #8b5cf6 100%);
          padding: 22px 28px; border-radius: 14px; margin-bottom: 18px;
          color: #ffffff; box-shadow: 0 4px 18px rgba(99,102,241,.25);
      }
      .app-banner h1 { margin: 0; font-size: 1.9rem; font-weight: 700; color: #ffffff; }
      .app-banner p  { margin: 6px 0 0; font-size: .95rem; color: #e0e7ff; }
...
# --------------------------------------------------------------------------- #
st.markdown(
    '<div class="app-banner"><h1>\U0001F4CA UAE Market Sales Analytics</h1>'
...
st.sidebar.download_button(
    ...
    file_name="UAE_Sales_Export.csv", mime="text/csv")
...
with tab_story:
    ...
    st.write(f"Across 2023-2024, the business generated {fmt_k(ts)} in the current view "
